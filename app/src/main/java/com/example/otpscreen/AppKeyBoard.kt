...
class AppKeyboard(context: Context?, attrs: AttributeSet?, defStyleAttr: Int) :
    ...
    private var mButtonHash: Button? = null
    ...
    private fun init(context: Context?, attrs: AttributeSet?) {
        ...
        mButtonHash = findViewById<View>(R.id.btnHash) as Button
        mButtonStar = findViewById<View>(R.id.btnStar) as Button
        ...
        keyValues.put(R.id.btnStar, "*")
        keyValues.put(R.id.btnHash, "#")
